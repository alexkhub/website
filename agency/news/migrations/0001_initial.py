    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genger', models.CharField(choices=[('М', 'Мужчина'), ('Ж', 'Женщина')], max_length=1, verbose_name='Пол')),
                ('nikname', models.CharField(max_length=50, unique=True, verbose_name='Никнейм')),
